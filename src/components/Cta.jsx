...
const Cta = () => {
  return (
    <section id="cta" className="bg-white relative py-12 lg:py-20 overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      <div className="bg-blue-600 rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl animate__animated animate__fadeIn">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#" className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-blue-600 bg-white hover:bg-gray-100 transition-colors duration-300">
              Start Free Trial
      ...
      <div className="mt-12 max-w-3xl mx-auto text-center text-sm text-gray-400">
