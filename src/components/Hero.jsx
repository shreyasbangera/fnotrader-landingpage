...
const Hero = () => {
  return (
    <section id="hero" className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      ...
      <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-full px-6 py-2 text-sm text-blue-600 font-medium animate-fade-in-up shadow-md">
