...
const Hero = () => {
  return (
    <section id="hero" className="bg-gradient-to-b from-blue-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-8 py-16 lg:py-20 relative">
        <div className="flex flex-col items-center max-w-3xl justify-center space-y-8 text-center">
          ...
          <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                ...
                />
                <img
                  src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=40&h=40&fit=crop&auto=format"
                  alt="Professional Trader"
                  className="w-8 h-8 rounded-full border-2 border-white object-cover"
                />
              </div>
