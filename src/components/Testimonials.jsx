        ...
        <div className="swiper-container">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-neutral-100 shadow-md">
              ...
              <p className="text-gray-600 leading-relaxed">My trading has greatly improved after I started using FNOTrader.com. They have some unique features that are super powerful for option buyers.</p>
            </div>
          </div>
        </div>
      </div>
