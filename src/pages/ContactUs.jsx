  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h2 className="text-3xl lg:text-4xl font-semibold text-gray-900 mb-4">Contact Us</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white hover:shadow-lg p-6 border border-gray-300 rounded-lg h-fullr">
            <div className='flex items-center gap-4 mb-6'>
              ...
              <a
                href="mailto:support@fnotrader.com"
                target="_blank"
        ...
        <div className="bg-white hover:shadow-lg p-6 border border-gray-300 rounded-lg h-full">
            <div className='flex items-center gap-4 mb-6'>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-1">YouTube</h3>
                <p className="text-sm text-gray-600">Watch trading tutorials</p>
              </div>
            </div>
            <a
              href="https://www.youtube.com/channel/UCZawT_YUYCmK3fT9FLd6TPA"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-between w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="bg-white hover:shadow-lg p-6 border border-gray-300 rounded-lg h-full">
            <div className='flex items-center gap-4 mb-6'>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-1">Blog</h3>
                <p className="text-sm text-gray-600">Read latest articles</p>
              </div>
            </div>
            <a
              href="https://www.blog.fnotrader.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-between w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="bg-white hover:shadow-lg p-6 border border-gray-300 rounded-lg h-full">
            <div className='flex items-center gap-4 mb-6'>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-1">Phone Support</h3>
                <p className="text-sm text-gray-600">Call us for support</p>
              </div>
            </div>
            <a
              href="tel:+918885635467"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-between w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
            >
